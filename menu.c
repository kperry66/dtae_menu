...
#define  FILE_NAME		"/u01/app/tcsg/Menu/menu.dat"   /*  menu data file		*/
#define  HEADER_FILE_NAME	"/u01/app/tcsg/Menu/header.dat"   /*  menu header file		*/
#define  GROUP_FILE_NAME	"/u01/app/tcsg/Menu/group.dat"	/* groups & users	*/
...
int disp_menu(int element){	/* Displays array and returns choice    
...
*/
	...
	for ( ctr = SCR_START;ctr <= SCR_END;ctr++ ){
		move(ctr,13);
		printw("%2d- %-15s   %.75s",disp_opt=element+1,
